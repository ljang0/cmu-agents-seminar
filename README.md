...
A compact academic seminar page: a short introduction to CMU PhD students and faculty, weekly meeting details, a Monday schedule table, sponsors (TBD), and organizer contacts. The illustrated blue header follows the friendly style of https://cmu-agent-workshop.github.io/; the schedule follows https://www.cs.cmu.edu/~mlaiseminar/. No workshop speakers, dates, sponsors, or logos are reused.
